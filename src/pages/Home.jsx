      ...
      <section className="bg-gradient-to-br from-green-800 to-green-600 text-white py-24 relative overflow-hidden">
        ...
        >
          <img
            ...
            alt=""
            className="object-cover h-full w-full blur-2xl opacity-40" style={{ borderTopLeftRadius: '21rem',objectPosition: 'right center',
              filter: 'blur(1px)',
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-100 rounded-xl overflow-hidden shadow-lg">
              ...
              <div className="p-4 text-sm text-gray-600">
                Cross-Section with Dr Thuweba Diwani (AV, DTC Nigeria) and Mr Faiz Muhammad (CEO, Blue Sapphire Hub)
              </div>
            </div>
          </div>
        </div>
