...
import { Menu, X, User, LogOut, Settings, ShoppingBag, MessageCircle, Plus, BookOpen } from 'lucide-react';
          ...
          <Link to="/" className="text-gray-700 hover:text-primary-600 transition-colors">
            ...
            {!user && (
              <>
                ...
                <Link to="/partnerships" className="text-gray-700 hover:text-primary-600 transition-colors">
                  Partnerships
                </Link>
              </>
            )}
            ...
            {user ? (
              ...
              <div className="flex items-center space-x-4">
                <Link to="/login" className="text-gray-700 hover:text-primary-600 transition-colors">
                  <ShoppingBag size={16} className="inline mr-1 text-blue-600" />
                  Marketplace
                </Link>
                <Link to="/lms" className="text-gray-700 hover:text-primary-600 transition-colors">
                  <BookOpen size={16} className="inline mr-1 text-green-600" />
                  LMS
                </Link>
              </div>
            )}
